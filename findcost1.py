...
print("To find the cheapest method of shipping type input weight and insert the weight of your package in the corresponding parenthesis")
while(1):
	x = input("\ntype weight: ")
	print(fin_cost(int(x)))
